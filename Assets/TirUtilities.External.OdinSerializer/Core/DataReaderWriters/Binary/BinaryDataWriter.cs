...
namespace TirUtilities.External.OdinSerializer
{
    using TirUtilities.External.OdinSerializer.Utilities;
    using TirUtilities.External.OdinSerializer.Utilities.Unsafe;
    using System;
